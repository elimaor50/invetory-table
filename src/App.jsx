    ...
    <div className="inventory-app" style={{ display: isMobile ? 'block' : 'flex', minHeight: '100vh', fontFamily: 'Segoe UI, Arial, sans-serif', fontSize: '1.3rem', background: 'linear-gradient(90deg, #f8fafc 0%, #e0e7ef 100%)', boxSizing: 'border-box', width: '100vw', maxWidth: '100vw', overflow: 'hidden', margin: 0, padding: 0, position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}>
      ...
      {(!isMobile || activeTab === 'add') && (
        <div style={{ flex: 1, minWidth: '350px', padding: '3rem 2rem', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxShadow: '2px 0 10px #e0e7ef', borderRadius: isMobile ? '0' : '0 2rem 2rem 0', height: isMobile ? 'auto' : '100vh', overflowY: 'auto' }}>
          ...
          <div className="add-item" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%', maxWidth: '400px', background: '#f1f5f9', padding: '2rem', borderRadius: '1rem', boxShadow: '0 2px 8px #e0e7ef', margin: '0 auto', boxSizing: 'border-box', alignItems: 'center' }}>
